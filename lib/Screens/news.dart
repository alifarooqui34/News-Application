...
class _HomeScreenState extends State<HomeScreen> implements NewsClass {
                      ...
                      child: InkWell(
                        onTap: () {
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) => NewsDesc(
                                        datee: items[index].date.toString(),
                                        descc:
                                            items[index].description.toString(),
                                        heading: items[index].id.toString(),
                                        image: items[index].image,
                                        auth: items[index].authorr.toString(),
                                      )));
                        },
                        child: Container(
                          height: 30.h,
  ...
  void onnewssuccess(FetchNews fetch) {
    print('Online status = ${fetch.status}');
