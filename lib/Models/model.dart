...
class FetchNews {
    ...
    FetchNews({this.status, this.totalResults, this.articles});

    FetchNews.fromJson(dynamic valueMap) {
      Map json = jsonDecode(valueMap);
        this.status = json["status"];
        this.totalResults = json["totalResults"];
        this.articles = json["articles"]==null ? null : (json["articles"] as List).map((e)=>Articles.fromJson(e)).toList();
    }
...
class Articles {
    ...
    Articles.fromJson(Map<String, dynamic> json) {
        this.source = json["source"] == null ? null : Source.fromJson(json["source"]);
